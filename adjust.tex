...
On save, the file contents are going to be reformatted, if possible.  However,
the current view is \emph{not} going to be refreshed, i.e., the formatted file
contents are only present in the connected file path but not in the editor.
This was a design decision in order to prevent confusion if the formatted and
unformatted states of the file would differ dramatically.
