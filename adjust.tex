...
\section{Self-Updating}
\label{sec:self-updating}
\adjust\ has a built-in self-updating mechanism which is defined as a wrapper
around \Vref{lst:download} and \Vref{lst:compilation}.  This command can be
called as illustrated by \Vref{lst:update}.
